        ...
        >
          <ChordLibraryEditor
            ...
            labels={{
              ...
              rootPicker: t("sidebar.tracks.chordRootPicker"),
              ...
              voicingSuggestions: t("sidebar.tracks.chordVoicingSuggestions"),
              voicingDensity: t("sidebar.tracks.chordVoicingDensity"),
              voicingCompact: t("sidebar.tracks.chordVoicingCompact"),
              voicingBalanced: t("sidebar.tracks.chordVoicingBalanced"),
              voicingFull: t("sidebar.tracks.chordVoicingFull"),
              voicingOpen: t("sidebar.tracks.chordVoicingOpen"),
              voicingMovable: t("sidebar.tracks.chordVoicingMovable"),
              voicingStrings: t("sidebar.tracks.chordVoicingStrings"),
              voicingRootPosition: (stringNumber) => t(
                "sidebar.tracks.chordVoicingRootPosition",
                { stringNumber },
              ),
              fretboardHelp: t("sidebar.tracks.chordFretboardHelp"),
              chordRecognitionHelp: t("sidebar.tracks.chordRecognitionHelp"),
              chordCompositionHelp: t("sidebar.tracks.chordCompositionHelp"),
              voicingSuggestionsHelp: t("sidebar.tracks.chordVoicingSuggestionsHelp"),
              voicingSuggestionsEmpty: t("sidebar.tracks.chordVoicingSuggestionsEmpty"),
              scoreDisplayHelp: t("sidebar.tracks.chordScoreDisplayHelp"),
            }}
