...
export const INSPECTOR_FIELD_CATALOG = {
  ...
  note: {
    ...
    fret: inlineNumber,
    string: inlineNumber,
    octave: field("popover", "pitch", "partial"),
    tone: field("popover", "pitch", "partial"),
    ...
    vibrato: readyEnum,
    slideInType: field("choice", "effect-choice", "partial"),
    slideOutType: field("choice", "effect-choice", "partial"),
    ...
    leftHandFinger: field("popover", "fingering", "missing"),
    rightHandFinger: field("popover", "fingering", "missing"),
    dynamics: field("choice", "dynamics", "missing"),
    ornament: field("choice", "effect-choice", "partial"),
    accidentalMode: field("popover", "accidental", "missing"),
  ...
  beat: {
    ...
    vibrato: field("choice", "effect-choice", "partial"),
    fade: readyEnum,
    ottava: missingEnum,
    golpe: missingEnum,
    ...
    lyrics: field("dialog", "lyrics", "missing"),
  ...
  score: {
    ...
    tab: inlineText,
    instructions: field("popover", "long-text", "partial"),
    notices: field("popover", "long-text", "partial"),
    defaultSystemsLayout: layout,
    systemsLayout: layout,
